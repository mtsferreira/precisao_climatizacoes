  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 20, flexWrap: 'wrap', marginBottom: 16 }}>
        <a href={waLink} target="_blank" rel="noopener noreferrer" style={{ color: COLORS.whatsapp, textDecoration: 'none', fontSize: '0.88rem' }}>
          {CONTACT.whatsappDisplay}
        </a>
        <a href={`mailto:${CONTACT.email}`} style={{ color: 'rgba(255,255,255,0.65)', textDecoration: 'none', fontSize: '0.88rem' }}>
          {CONTACT.email}
        </a>
      </div>
