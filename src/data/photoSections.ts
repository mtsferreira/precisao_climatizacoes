...
export const photoSections: PhotoSectionData[] = [
  {
    ...
    description:
      'Realizamos instalações e manutenções em ambientes industriais e comerciais de grande porte. Nossos técnicos garantem que cada equipamento opere com máxima eficiência, assegurando conforto térmico e preservando a vida útil dos sistemas instalados.',
